...
const CTASection = ({ heading, subheading, ctaLabel, ctaHref }: CTASectionProps) => (
  <section className="py-14 sm:py-20 lg:py-28 bg-secondary text-secondary-foreground">
    <div className="section-container text-center">
      <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold leading-tight tracking-tight mb-6 max-w-3xl mx-auto">{heading}</h2>
      {subheading && <p className="text-base sm:text-lg text-secondary-foreground/70 max-w-2xl mx-auto mb-10">{subheading}</p>}
