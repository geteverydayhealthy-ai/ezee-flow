...
import imgSolves from "@/assets/visuals/v6-perf-acquisition.jpg";
import imgIncludes from "@/assets/visuals/v6-perf-funnel.jpg";
import imgMatters from "@/assets/visuals/v7-perf-outcome.jpg";
