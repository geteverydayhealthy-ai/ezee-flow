...
const SolutionsOverview = () => (
  <Layout>
    <PageHero
      heading="Specialized solutions for modern insurance businesses"
      subheading="Ezee Technologies combines insurance-native design, growth, technology, operations, and AI into focused execution pods that solve real business problems across the insurance value chain."
    ...
    <section className="section-spacing bg-accent/50">
      <div className="section-container max-w-3xl mx-auto text-center">
        <p className="text-lg text-muted-foreground leading-relaxed">
          Some insurers need a stronger growth funnel. Some need digital infrastructure. Some need operational modernization. Some need all of it working together. Our solution model is modular by design.
        </p>
      </div>
    </section>
