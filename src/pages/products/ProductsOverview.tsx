...
const ProductsOverview = () => (
  <Layout>
    <PageHero
      heading="Products built for modern insurance execution"
      subheading="Ezee Technologies builds modular products that help insurers modernize customer journeys, operations, distribution, visibility, and decision-making without forcing rigid systems or hardcoded logic."
    ...
    <CTASection heading="Let's build the right digital layer for your insurance business" ctaLabel="Book a Demo" ctaHref="/contact" />
  </Layout>
);
